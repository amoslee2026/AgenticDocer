...
.. code-block:: python
    ...
    from agenticspec.auth import write_context
    from agenticspec.agent_api.deps import WriteAuth, StorageDep
...
from agenticspec.auth.rbac import MANAGE_USERS
from agenticspec.model import Doc, DocTarget, Model, Violation
