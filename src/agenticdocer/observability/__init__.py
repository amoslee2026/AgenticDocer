...
* :class:`HealthReport` / :func:`health`——`agenticdocer stats --health` 与 M09B `perf_health`；
...
from agenticdocer.observability.error_codes import (
    DTO_ANCHOR_CONFLICT,
    DTO_AUTH_REJECTED,
...
from agenticdocer.observability.health import (
    HealthReport,
    IndexHealth,
    PartitionHealth,
    PoolHealth,
...
from agenticdocer.observability.logger import (
    PROGRAM,
    ModuleLogger,
    classify_duration,
    command_for,
...
from agenticdocer.observability.metrics import (
    EndpointMetric,
    MetricsSnapshot,
    RenderMetric,
    SlowQuery,
...
from agenticdocer.observability.rid import (
    current_rid,
    new_rid,
    reset_rid,
    rid_scope,
