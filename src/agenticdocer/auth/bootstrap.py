...
:class:`~agenticdocer.auth.errors.BootstrapError`，错误信息指向自举步骤；系统在无
active admin 期间对**所有**端点 401（M06/M07 侧由 :func:`agenticdocer.auth.middleware.require_auth`
...
from agenticdocer.model import User, new_uuid7
from agenticdocer.observability import get_logger
from agenticdocer.store import Database, append_event, get_database, now
...
async def bootstrap_admin(
    ...
    from agenticdocer.store.schema import ssh_keys, users as users_table
