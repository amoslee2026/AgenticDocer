...
| `terms.definition_node_id → nodes(node_id)` | :mod:`agenticdocer.m09.quality_9b.terms`（术语面同表读取） |
...
from agenticdocer.store.schema import comments, docs, events, nodes, refs
