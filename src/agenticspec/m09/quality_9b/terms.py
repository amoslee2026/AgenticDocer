...
from agenticspec.model import TermKind, Violation
from agenticspec.store import ValidationError
from agenticspec.store.schema import nodes, terms
...
"""`src/agenticspec/m09/quality_9b/terms.py` → 仓库根（parents: quality_9b, m09, agenticspec, src）。"""
